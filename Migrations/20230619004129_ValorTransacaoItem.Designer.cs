...
namespace ProjetoMobileSustentabilidade.Migrations
{
    ...
    [Migration("20230619004129_ValorTransacaoItem")]
    partial class ValorTransacaoItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto_Mobile_Sustentabilidade.Data.Models.TransacaoItensUsina", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IdTransacaoUsina")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdTransacaoUsina");

                    b.ToTable("TransacoesItensUsina");
                });
            ...
            modelBuilder.Entity("Projeto_Mobile_Sustentabilidade.Data.Models.TransacaoItensUsina", b =>
                {
                    ...
                    b.HasOne("Projeto_Mobile_Sustentabilidade.Data.Models.TransacaoUsina", "TransacaoUsina")
                        .WithMany()
                        .HasForeignKey("IdTransacaoUsina")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("Liquido");

                    b.Navigation("TransacaoUsina");
                });
